...
def doBisection(limitlower,upperanger,funtion,iterations,tolerance):
   a=limitlower
   b=upperanger
   f=funtion
   i=iterations
            ...
            if (fun1()*fun2())>0:
                ...
                if funm() == 0:
                        ...
                        if error < tol:
                                ...
                                return "Se encontró una aproximación de la raiz en ","{:18.15f}".format(c)
                        else:
                                print ("failed")
                                return "failed"
